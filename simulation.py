...
def tempSimulation(_helper: NucarnivalHelper, _cardHelper: CardHelper):
    ...
    qiangHl = _cardHelper.filterCard('ApatheticOutsider')[0]
    ...
    shengKun = _cardHelper.filterCard('ArcticWarden')[0]
