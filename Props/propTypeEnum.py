...
class PropType(enum.Enum):
    ...
    essenceContract = '魔力契约', '600钻1抽'
    coin = '金币', '50钻14000金币（魔法师特权商店）'
    tinyBoost = '微型日月精华（10体力）', '200钻120体力（直接购买）'
    basicBoost = '初级日月精华（30体力）', '200钻120体力（直接购买）'
    strongBoost = '上级日月精华（100体力）', '200钻120体力（直接购买）'
    basicPotential = '初级潜力道具', '1个初级潜力道具=1/6个中级潜力道具（合成）'
    intermediatePotential = '中级潜力道具', '80钻2个中级潜力道具（魔法师特权商店）'
    advancedPotential = '高级潜力道具', '80钻1个高级潜力道具（魔法师特权商店）'
    advancedUpPotential = '高级潜力道具（合成）', '600钻一个高级合成潜力道具（魔法师特权商店）'
    legendaryPotential = '传说潜力道具', '传说潜力道具=2个高级合成+3个中级（合成）'
    smallEssenceVial = '小瓶魔力熏香（1蜜话次数）', '1红钻10点蜜话点（直接购买）'
    middleEssenceVial = '中瓶魔力熏香（5蜜话次数）', '1红钻10点蜜话点（直接购买）'
    bigEssenceVial = '大瓶魔力熏香（10蜜话次数）', '1红钻10点蜜话点（直接购买）'
    expressPass = '快速通关券', '60钻1通关券（直接购买，魔法师特权等级有折扣）'
    key = '钥匙', '1600钻1把钥匙（神秘商人）'
    fancyKey = '高级钥匙', '1把高级钥匙=5把钥匙（合成）'
    basicGift = '初级礼物', '1个初级礼物=0.5个中级礼物'
    intermediateGift = '中级礼物', '20钻6个中级礼物（魔法师特权商店）'
    advancedGift = '高级礼物', '30钻3个高级礼物（魔法师特权商店）'
    ultraGift = '回忆图画', '180钻3个回忆图画（魔法师特权商店）'
    holyWater_S = '小型祝福药水', '小型祝福药水：晶灵石=5：4（来源攻略组）'
    holyWater_M = '中型祝福药水', '中型祝福药水：晶灵石=5：8（来源攻略组）'
    holyWater_L = '大型祝福药水', '大型祝福药水=2.5瓶中型祝福药水'
    holyWater_XL = '特大型祝福药水', '1红钻25个特大型祝福药水（神秘商人）'
    crystalCore = '闪耀晶核', '60红钻1个闪耀晶核（神秘商人）'
    rawCrystal = '晶花原石', '45红钻1个晶花原石（神秘商人）'
