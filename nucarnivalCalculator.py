...
class MainWindow(QMainWindow):
    ...
    def initWindowData(self):
        ...
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Aster.value), CardRole.Aster)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Morvay.value), CardRole.Morvay)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Yakumo.value), CardRole.Yakumo)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Edmond.value), CardRole.Edmond)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Olivine.value), CardRole.Olivine)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Quincy.value), CardRole.Quincy)
        self.ui.filterRoleComboBox.addItem(_translate("MainWindow", CardRole.Kuya.value), CardRole.Kuya)
        ...
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Morvay.value), CardRole.Morvay)
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Yakumo.value), CardRole.Yakumo)
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Edmond.value), CardRole.Edmond)
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Olivine.value), CardRole.Olivine)
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Quincy.value), CardRole.Quincy)
        self.ui.filterRoleComboBox_2.addItem(_translate("MainWindow", CardRole.Kuya.value), CardRole.Kuya)
